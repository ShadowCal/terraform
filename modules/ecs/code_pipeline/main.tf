...
resource "aws_codebuild_project" "shadowcal_build" {
  name          = "shadowcal-codebuild"
  build_timeout = "10"
...
resource "aws_codepipeline" "pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ProjectName = "shadowcal-codebuild"
      }
    }
  }
